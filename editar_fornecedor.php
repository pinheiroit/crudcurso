...
<body>
        ...
        <h4>Edição do Fornecedor</h4>
            <form action="_atualizar_fornecedor.php" method="post" style= "margin-top: 20px">

                        <?php 
                        $sql = "SELECT * FROM `fornecedor` where codfornec = $codfornec";
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="codfornec" value = "<?php echo $codfornec ?>" readonly>
                </div>
